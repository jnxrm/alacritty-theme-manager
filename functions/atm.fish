...
function atm -d "alacritty-theme-manager"
    ...
    # Starred themes
    if not test -e $ala_path/themes_starred
        echo $(touch $ala_path/themes_starred)
    end
    echo $(cat $ala_path/themes_starred)|read -a themes_starred
    ...
    # Current theme
    if not test -e $ala_path/theme_current
        echo $(touch $ala_path/theme_current)
        echo base16_default_dark >> $ala_path/theme_current
    else
        if contains $(cat $ala_path/theme_current) $themes_all
            set theme_current $(cat $ala_path/theme_current)
        else
    ...
    if count $argv > /dev/null
        switch $argv[1]
                ...
                switch $(count $argv)
                    ...
                    case 1
                        if not contains $theme_current $themes_starred
                            echo $theme_current >> $ala_path/themes_starred
                        ...
                        # Star <theme>
                            ...
                            if contains $theme $themes_all
                                if not contains $theme $themes_starred
                                    echo $theme >> $ala_path/themes_starred
                ...
                switch $(count $argv)
                    ...
                    case 1
                        if contains $theme_current $themes_starred
                            ...
                            echo -n > $ala_path/themes_starred
                            for theme_starred in $themes_starred
                                echo $theme_starred >> $ala_path/themes_starred
                            end
            ...
            case \*
                if contains $argv $themes_all
                    ...
                    mv $ala_path/$argv.toml $ala_path/theme.toml
                    echo -n > $ala_path/theme_current
                    echo $argv >> $ala_path/theme_current
        ...
        while test $counter -lt 10
            ...
            mv $ala_path/$theme_random.toml $ala_path/theme.toml
            sleep 0.05
        end
        ...
        echo -n > $ala_path/theme_current
        echo $theme_random >> $ala_path/theme_current
    end
end