...
function atm -d "alacritty-theme-manager"
    ...
    # Starred themes
    if not test -e $atm_path/themes_starred
        echo $(touch $atm_path/themes_starred)
    end
    echo $(cat $atm_path/themes_starred)|read -a themes_starred
    ...
    # Current theme
    if not test -e $atm_path/theme_current
        echo $(touch $atm_path/theme_current)
        echo base16_default_dark >> $atm_path/theme_current
    else
        if contains $(cat $atm_path/theme_current) $themes_all
            set theme_current $(cat $atm_path/theme_current)
        else
    ...
    if count $argv > /dev/null
        switch $argv[1]
                ...
                switch $(count $argv)
                    ...
                    case 1
                        if not contains $theme_current $themes_starred
                            echo $theme_current >> $atm_path/themes_starred
                        ...
                        # Star <theme>
                            ...
                            if contains $theme $themes_all
                                if not contains $theme $themes_starred
                                    echo $theme >> $atm_path/themes_starred
                ...
                switch $(count $argv)
                    ...
                    case 1
                        if contains $theme_current $themes_starred
                            ...
                            echo -n > $atm_path/themes_starred
                            for theme_starred in $themes_starred
                                echo $theme_starred >> $atm_path/themes_starred
                            end
            ...
            case \*
                if contains $argv $themes_all
                    ...
                    echo -n > $atm_path/theme_current
                    echo $argv >> $atm_path/theme_current
        ...
        echo -n > $atm_path/theme_current
        echo $theme_random >> $atm_path/theme_current
    end
end